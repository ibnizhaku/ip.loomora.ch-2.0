...
export class JournalEntriesController {
  ...
  create(@Body() dto: CreateJournalEntryDto, @CurrentUser() user: any) {
    return this.journalEntriesService.create(user.companyId, dto);
  }
  ...
  update(
    ...
    return this.journalEntriesService.update(id, user.companyId, dto);
  }

  @Post(':id/post')
  @ApiOperation({ summary: 'Post journal entry' })
  post(@Param('id') id: string, @CurrentUser() user: any) {
    return this.journalEntriesService.post(id, user.companyId);
  }
  ...
  reverse(
    ...
    return this.journalEntriesService.reverse(id, user.companyId, dto);
  }

  @Delete(':id')
  @ApiOperation({ summary: 'Delete journal entry (draft only)' })
  delete(@Param('id') id: string, @CurrentUser() user: any) {
    return this.journalEntriesService.delete(id, user.companyId);
  }
}
