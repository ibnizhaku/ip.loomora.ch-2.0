  ...
  async create(companyId: string, userId: string, dto: CreateInvoiceDto) {
    ...
    const created = await this.prisma.invoice.create({
      data: {
        ...
        shippingAddress: (dto.shippingAddress as any) ?? undefined,
        billingAddress: (dto.billingAddress as any) ?? undefined,
        servicePeriodFrom: dto.servicePeriodFrom ? new Date(dto.servicePeriodFrom) : undefined,
        servicePeriodTo: dto.servicePeriodTo ? new Date(dto.servicePeriodTo) : undefined,
        earlyPaymentDiscount: dto.earlyPaymentDiscount ?? undefined,
        earlyPaymentDays: dto.earlyPaymentDays ?? undefined,
