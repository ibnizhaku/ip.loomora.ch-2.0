...
const managementItems: NavItem[] = [
  ...
  { title: "Kalkulation", url: "/calculation", icon: Calculator, keywords: ["kalk", "preis"], permission: "quotes" },
  { title: "Produktion", url: "/production", icon: Factory, keywords: ["werkstatt", "fertigung"], permission: "production-orders" },
  { title: "QS-Prüfung", url: "/quality", icon: ClipboardCheck, keywords: ["qualität", "prüfung"], permission: "quality-control" },
  { title: "Service", url: "/service", icon: Wrench, keywords: ["wartung", "reparatur"], permission: "service-tickets" },
